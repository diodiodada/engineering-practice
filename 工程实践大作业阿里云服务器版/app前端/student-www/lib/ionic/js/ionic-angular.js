...
function($scope, $attrs, $element, $timeout) {
  ...
  function finishInfiniteScroll() {
    ...
    $timeout(function() {
      ...
      // only check bounds again immediately if the pages isn't cached (scroll el has height)
...
.directive('ionPager', function() {
  return {
    ...
    replace: true,
    require: '^ionSlideBox',
    template: '<div class="slider-pager"><span class="slider-pager-pages" ng-repeat="slide in numSlides() track by $index" ng-class="{active: $index == currentSlide}" ng-click="pagerClick($index)"><i class="icon ion-record"></i></span></div>',
