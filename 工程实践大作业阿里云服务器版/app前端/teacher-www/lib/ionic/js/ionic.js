...
(function(ionic) {
  ...
  /**
   * Drag
   * Move with x fingers (default 1) around on the pages. Blocking the scrolling when
  ...
  ionic.Gestures.gestures.Touch = {
    ...
    defaults: {
      ...
      // disabling the scrolling of the pages, but it improves gestures like
...
ionic.views.Scroll = ionic.views.View.inherit({
  initialize: function(options) {
    ...
    self.options = {
      ...
      /** Enable pagination mode (switching between full pages content panes) */
      paging: false,
  ...
  */
  ...
  /**
   * Move and scale the scrollbars as the pages scrolls.
   */
  ...
  */
  ...
  __startDeceleration: function() {
    ...
    if (self.options.paging) {
      ...
      // Each pages should have exactly the size of the client area.
